...
namespace BookStoreRepository.Repository
{
    public class UserRepository : IUserRepository
    {
        ...
        public async Task<int> UserRegistration(UserRegister register)
        {
            ...
            try
            {
                ...
                com.Parameters.AddWithValue("@FullName", register.FullName);
                com.Parameters.AddWithValue("@EmailId", register.EmailId);
                com.Parameters.AddWithValue("@password", password);
                com.Parameters.AddWithValue("@MobileNumber", register.MobileNumber);
                com.Parameters.AddWithValue("@IsAdmin", register.IsAdmin);
                con.Open();
        ...
        public string UserLogin(string email, string password)
        {
            ...
            try
            {
                ...
                nlog.LogDebug("User Sucessed Logged In");
                return null;
            }
            catch (Exception ex)
            {
